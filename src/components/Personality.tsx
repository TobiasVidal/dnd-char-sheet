    ...
    return <div>
        ...
        <div className="row mt-5">
            ...
            <div className="col-8 px-4">
                <Appearance appearance={character.charPersonality} />
                <div className="row mb-4">
                    <div className="col-6 ps-0">
                        <div className="bg-dark-light p-3 personality-box">
                            <h4 className="themetext-secondary">Traits</h4>
                            {character.charPersonality.traits.map((x, i) => <p key={i}>{x}</p>)}
                        </div>
                    </div>
                    <div className="col-6 pe-0">
                        <div className="bg-dark-light p-3 personality-box">
                            <h4 className="themetext-secondary">Ideals</h4>
                            {character.charPersonality.ideals.map((x, i) => <p key={i}>{x}</p>)}
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-6 ps-0">
                        <div className="bg-dark-light p-3 personality-box">
                            ...
                            {character.charPersonality.bonds.map((x, i) => <p key={i}>{x}</p>)}
                        </div>
                    </div>
                    <div className="col-6 pe-0">
                        <div className="bg-dark-light p-3 personality-box">
                            <h4 className="themetext-secondary">Flaws</h4>
                            {character.charPersonality.flaws.map((x, i) => <p key={i}>{x}</p>)}
                        </div>
                    </div>
                </div>
            </div>
